...
当前公开版本为预发布版本 `0.1.0`。软件许可和完整外部数据复现尚未最终确认；条件满足后可发布 `1.0.0`。
...
> Yes — the methods and experimental use have been described in associated scientific publications, and the sanitized `v0.1.0` source package is publicly available on GitHub.
